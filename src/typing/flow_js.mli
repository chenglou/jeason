...
val reposition: Context.t -> ?trace:TraceFlow.t -> reason -> Type.t -> Type.t

(* constraint utils *)
val filter_optional: Context.t -> ?trace:TraceFlow.t -> reason -> Type.t -> Type.t
...
val get_builtin_typeapp: Context.t -> ?trace:TraceFlow.t -> reason -> string -> Type.t list -> Type.t
...
val get_builtin: Context.t -> ?trace:TraceFlow.t -> string -> reason -> Type.t
val lookup_builtin: Context.t -> ?trace:TraceFlow.t -> string -> reason -> Type.lookup_kind -> Type.t -> unit
val get_builtin_type: Context.t -> ?trace:TraceFlow.t -> reason -> string -> Type.t
val resolve_builtin_class: Context.t -> ?trace:TraceFlow.t -> Type.t -> Type.t
val set_builtin: Context.t -> ?trace:TraceFlow.t -> string -> Type.t -> unit

val mk_instance: Context.t -> ?trace:TraceFlow.t -> reason -> ?for_type:bool -> Type.t -> Type.t
val mk_typeof_annotation: Context.t -> ?trace:TraceFlow.t -> Type.t -> Type.t
